...
0: (function(module, __webpack_exports__, __webpack_require__) {
  ...
  (function(global) {
    global.currentModuleId = "mf5af2cbe"
    global.currentResource = "/Users/didi/Desktop/test-mpx-jd/src/app.mpx"
    global.currentCtor = App
    global.currentCtorType = "app"
    global.currentSrcMode = "wx"
    var _babel_loader_node_modules_mpxjs_webpack_plugin_lib_selector_type_script_index_0_app_mpx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
...
2: (function(module, __webpack_exports__, __webpack_require__) {
  ...
  var _mpxjs_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
  var _mpxjs_api_proxy__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(216);

  _mpxjs_core__WEBPACK_IMPORTED_MODULE_0__["default"].use(
    _mpxjs_api_proxy__WEBPACK_IMPORTED_MODULE_1__["default"], 
    { 
      usePromise: true 
    }
  );
...
/* harmony import */ var babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var babel_runtime_core_js_object_create__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(153);
...
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(218);
/* harmony import */ var _platform_wxToAli__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(222);
...
var fromMap = Object(_common_js__WEBPACK_IMPORTED_MODULE_3__["genFromMap"])();
...
function transformApi(options) {
  ...
  var envObj = Object(_common_js__WEBPACK_IMPORTED_MODULE_3__["getEnvObj"])();
  var wxToAliApi = Object(_platform_wxToAli__WEBPACK_IMPORTED_MODULE_4__["default"])({ optimize: options.optimize });
  var platformMap = {
    'wx_ali': wxToAliApi,
    'qq_ali': wxToAliApi,
    'jd_ali': wxToAliApi,
  ...
  var needProxy = babel_runtime_core_js_object_assign__WEBPACK_IMPORTED_MODULE_2___default()({}, envObj, wxToAliApi);
  var transedApi = babel_runtime_core_js_object_create__WEBPACK_IMPORTED_MODULE_1___default()(null);

  babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(needProxy).forEach(function (api) {
    // 非函数不做转换
    ...
    transedApi[api] = function () {
      ...
      } else if (platformMap[fromTo] && platformMap[fromTo][api] && options.exclude.indexOf(api) < 0) {
        return platformMap[fromTo][api].apply(_this, args);
      } else if (envObj[api]) {
        return envObj[api].apply(_this, args);
      } else {
        Object(_common_js__WEBPACK_IMPORTED_MODULE_3__["error"])('\u5F53\u524D\u73AF\u5883\u4E0D\u5B58\u5728 ' + api + ' \u65B9\u6CD5');
      }
    };
  });
...
function genFromMap() {
  var result = {};
  var platforms = ['wx', 'ali', 'swan', 'qq', 'jd', 'tt', 'web'];
